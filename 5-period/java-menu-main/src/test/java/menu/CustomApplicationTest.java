        ...
        void 기능_테스트() {
            assertTimeoutPreemptively(RANDOM_TEST_TIMEOUT, () -> {
                final Executable executable = () -> {
                    runException("구구,제임스", "김밥,카오 팟", "라자냐");
                    ...
                    assertThat(output()).contains(
                            ...
                            "[ 카테고리 | 일식 | 중식 | 아시안 | 한식 | 양식 ]",
                            "[ 구구 | 규동 | 짜장면 | 나시고렝 | 김치찌개 | 스파게티 ]",
                            "[ 제임스 | 가츠동 | 짬뽕 | 파인애플 볶음밥 | 제육볶음 | 뇨끼 ]",
                            "추천을 완료했습니다."
                    );
                };

                assertRandomTest(executable,
                        Mocking.ofRandomNumberInRange(1, 3, 4, 2, 5),   // 숫자는 카테고리 번호를 나타낸다.
                        Mocking.ofShuffle(
                                ...
                                List.of("나시고렝", "팟타이", "카오 팟", "파인애플 볶음밥", "쌀국수", "똠얌꿍", "반미", "월남쌈", "분짜"),    // 구구
                                ...
                                List.of("뇨끼", "그라탱", "라자냐", "끼슈", "프렌치 토스트", "바게트", "스파게티", "피자", "파니니")    // 제임스
                        )
                );
            });
        }
